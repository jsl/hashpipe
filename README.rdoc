...
HashPipe allows you to have an attribute of an existing ActiveRecord (AR)-backed class stored in a separate system, such as S3 or Tokyo Cabinet.  In this sense, it provides a pipe from an AR object to a hash - a hash pipe!
